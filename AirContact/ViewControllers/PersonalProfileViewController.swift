...
UINavigationControllerDelegate  {
    ...
    @IBOutlet weak var genderUITextField: UITextField!
    ...
    @IBAction func onClickSave(_ sender: Any) {
        ...
        if let gender = genderUITextField.text, gender.isEmpty
        {
            displayMessage(message: "Gender Required")
        }
    ...
    func saveData() {
        ...
        let personalProfile = NSEntityDescription.insertNewObject(forEntityName: "PersonalProfile", into: context)
        
        personalProfile.setValue(cityUITextField.text, forKey: "city")
        personalProfile.setValue(countryUITextField.text, forKey: "country")
        personalProfile.setValue(fullNameUITextField.text, forKey: "fullname")
        personalProfile.setValue(genderUITextField.text, forKey: "gender")
        personalProfile.setValue(phoneUITextField.text, forKey: "phone")
        ...
        do
        {
            ...
            if results.count > 0
            {
                for result in results as! [NSManagedObject]
                {
                    ...
                    genderUITextField.text  = (result.value(forKey: "gender") as? String)!
